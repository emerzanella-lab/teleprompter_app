...
function LiveScreen({
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "live",
    "data-screen-label": `04 Live (${variant})`,
    onClick: () => playing && setShowControls(s => !s)
  }, settings.camera && stream ? /*#__PURE__*/React.createElement("video", {
    ref: videoRef,
    autoPlay: true,
    playsInline: true,
    muted: true,
    ...
    className: "live-camera fallback"
  }), /*#__PURE__*/React.createElement("div", {
    className: "live-veil"
  }), /*#__PURE__*/React.createElement("div", {
  ...
  }, variant === 'classic' && /*#__PURE__*/React.createElement(ClassicScroll, {
    body: script.body,
    fontSize: fontSize,
    speed: speed,
    playing: playing,
    elapsed: elapsed,
    textPos: textPos
  }), variant === 'focus' && /*#__PURE__*/React.createElement(FocusScroll, {
    body: script.body,
    fontSize: fontSize,
    speed: speed,
    playing: playing,
    elapsed: elapsed,
    textPos: textPos
  }), variant === 'karaoke' && /*#__PURE__*/React.createElement(KaraokeScroll, {
    body: script.body,
    fontSize: fontSize,
    speed: speed,
    playing: playing,
    ...
    className: "live-fade-top"
  }), /*#__PURE__*/React.createElement("div", {
    className: "live-fade-bottom"
  }), variant === 'classic' && /*#__PURE__*/React.createElement("div", {
    className: "tp-marker",
    style: {
      top: `${textPos}%`
    }
  ...
  })), variant === 'focus' && /*#__PURE__*/React.createElement("div", {
  ...
  }, /*#__PURE__*/React.createElement(Icon.Rewind, {
    color: "#fff"
    ...
    key: countdown
  }, countdown)), showControls && /*#__PURE__*/React.createElement("div", {
    className: "live-controls",
    onClick: e => e.stopPropagation()
  }, /*#__PURE__*/React.createElement("div", {
    className: "live-control-row"
  }, /*#__PURE__*/React.createElement("div", {
    className: "live-pill",
    style: {
      flex: 1,
  ...
  }, /*#__PURE__*/React.createElement(Icon.TextSize, {
    size: 20,
    color: "#fff"
  ...
  }, fontSize))), /*#__PURE__*/React.createElement("div", {
    className: "live-control-row"
  }, /*#__PURE__*/React.createElement("div", {
    className: "live-pill",
    style: {
  ...
  }, textPos, "%"))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      alignItems: 'center',
  ...
  }, fmtTime(elapsed), " \xB7 ", wordCount, " palavras")), /*#__PURE__*/React.createElement("button", {
    className: `live-play ${settings.record ? 'recording' : ''}`,
    onClick: togglePlay
  }, playing ? /*#__PURE__*/React.createElement(Icon.Pause, {
    size: 32,
  ...
  }, "Concluir")))), !showControls && playing && /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'absolute',
      bottom: 60,
      left: 0,
...
function KaraokeScroll({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    if (tok.kind === 'break') return /*#__PURE__*/React.createElement("div", {
      key: i,
      style: {
        height: '1.2em'
      }
